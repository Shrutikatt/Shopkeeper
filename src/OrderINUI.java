...
public class OrderINUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnClear.setFont(new java.awt.Font("Yu Gothic Medium", 1, 12)); // NOI18N
        ...
        jLabel10.setFont(new java.awt.Font("Footlight MT Light", 1, 36)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(153, 153, 0));
        jLabel10.setText("Sports Item Order Form");

        btnSave.setFont(new java.awt.Font("Yu Gothic Medium", 1, 12)); // NOI18N
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        try {
            ...
            Connection con = (Connection)
                    DriverManager.getConnection("jdbc:mysql://localhost:3306/shopkeeper","root","mgn");
            Statement stmt = null;
            ...
            String strSQL = "INSERT INTO orderitem(OderNo, OrderDate, Item_Id, Shopper_Id, Quantity, price, discount, Amount ) VALUES ('"+(OrdNo)+"','"+(OrdDate)+"','"+(ItemID)+"','"+(ShopID)+"',"+(ordQty)+","+iPrice+","+ discP+","+(amt)+")";
            ...
            rs = stmt.executeQuery(SQL);
            String query = "update item set Quantity ='"+(Quantity-OrdQty) where Item_ID ="+Item_ID+";";
            con.close();
    ...
    private void jList2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList2MouseClicked
        try {
            ...
            String ItemID = ItemIDName.substring(0, 4);
